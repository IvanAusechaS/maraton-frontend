    ...
    <nav className="navbar">
      <div className="navbar__container">
        ...
        <div className="navbar__main-links desktop-menu">
          ...
          <Link to="/peliculas" className="navbar__link">Catálogo</Link>
        ...
        <div className="navbar__tools desktop-menu">
          <div className="navbar__filter">
            <button
              className={`navbar__filter-button ${isFilterOpen ? 'active' : ''}`}
              onClick={toggleFilter}
              aria-haspopup="true"
              aria-expanded={isFilterOpen}
            >
              {selectedFilter}
              <img src="/arrow-color.svg" alt="toggle" className={`navbar__filter-arrow ${isFilterOpen ? 'active' : ''}`} />
            </button>

            {isFilterOpen && (
              <div className="navbar__filter-dropdown">
                {FILTERS.map((f) => (
                  <button key={f.key} className="navbar__filter-item" onClick={() => handleSelectFilter(f.label)}>
                    {f.label}
                  </button>
                ))}
              </div>
